...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-04 16:04`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c0f6da3b-bee9-491e-8b14-a07a20561add.git
$ cd c0f6da3b-bee9-491e-8b14-a07a20561add
```
